%executes RANSAC method for given datasets of corresponding points 2xdata_size and makes it_num
%iterations with tol tolerance

function [L1_best, L2_best, F_best] =  ransac(x, y, xx, yy, data_size, it_num, tol)
    num_best = 0;
%     x = dataset_fst(1, :);
%     y = dataset_fst(2, :);
%     xx = dataset_snd(1, :);
